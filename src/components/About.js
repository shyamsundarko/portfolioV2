    ...
    <div>
            ...
            <Grid container id="aboutMeContainer"> 
                ...
                <Grid item xs={12} md={6}>
                    ...
                    Originating from Singapore, I bring a unique perspective shaped by diverse experiences, including my mandatory two-year military service. This has instilled in me valuable skills such as discipline, adaptability, and effective teamwork. <br/> <br/> As a results-driven software engineering master's student, I possess a deep expertise in full-stack engineering, with a particular passion for frontend development. 
                    </p>
                </Grid>
            </Grid>
            <Grid item xs={12} md={1} />
