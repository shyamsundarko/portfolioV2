  ...
  return (
    <Grid container id="educationContainer">
        ...
        <Grid container item xs={12} className="individualEducationContainer">
            ...
            <Grid item xs={12} md={5}  style={{paddingTop:"3vmin"}} data-aos="fade-left" data-aos-once="true">
        ...
        <Grid container item xs={12} className="individualEducationContainer">
            ...
            <Grid item xs={12} md={5} data-aos="fade-left" style={{paddingTop:"3vmin"}} data-aos-once="true">
